      ...
      <div className="max-w-5xl mx-auto py-12 px-4">
        ...
        <section id="valores" aria-labelledby="valores-heading" className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <article className="p-6 border rounded-lg border-gray-300 bg-white">
        ...
        <section className="mt-12 text-center">
          ...
          <Link href="/contact" className="inline-block mt-6 px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:opacity-90">Fale conosco</Link>
        </section>
      </div>
    </main>
  )
